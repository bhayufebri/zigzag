...
@section('content')
    ...
    <h2 class="text-dark m-0 mb-3"> EDIT ARTICLE</h2>

    <form  action="{{ route('articles.update', $pages->id) }}" method="post" enctype="multipart/form-data">
        <div class="card border-0 bg-white shadow-sm mb-4">
            <div class="card-body p-5">
                <div class="form">
                    @include('dashboard.articles._form-side')
                </div>
            </div>
        </div>
        ...
        <br/>
        <input class="btn bg-accent text-white py-3 px-5 d-block d-md-inline-block" value="Update" type="submit" />
    </form>
@endsection
