...
@section('content')
        ...
        <div class="card-body p-5">
            ...
            @if(isset($page->image))
                <div class="form-group row border-bottom border-light">
                    ...
                    <div class="col-md-10">
                        <img class="img-responsive" width="200px" height="200px" src="{{ asset('uploads/image/articles/'.$page->image) }}" />
                    </div>
                </div>
            @endif
    ...
    <a href="{{ route('articles.index') }}" class="btn bg-secondary text-white px-4 d-block d-md-inline-block">Back</a>
    <a class="btn bg-warning text-white px-4 d-block d-md-inline-block" href="{{route('articles.edit', $page->id)}}"> Edit</a>
